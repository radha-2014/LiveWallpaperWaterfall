...
public class GLWallpaperService extends WallpaperService {
	...
	public class GLEngine extends Engine {
		...
		public void onCreate(SurfaceHolder surfaceHolder) {
			...
			BackgroundUtil.initializeImagesList(GLWallpaperService.this);
			...
			mRenderer = new WallpaperRenderer(GLWallpaperService.this, true);
		    if (supportsEs2) {
		...
		public void setEGLWindowSurfaceFactory(
				GLSurfaceView.EGLWindowSurfaceFactory factory) {
			checkRenderThreadState();
...
class DefaultWindowSurfaceFactory implements
